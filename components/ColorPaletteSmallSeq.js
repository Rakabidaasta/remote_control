...
import { monoUrl, seqUrl } from "../assets/endpoints"


class ColorPaletteSmallSeq extends React.Component {
    ...
    chooseColors = ["#D2D2D2", "#D2D2D2", "#D2D2D2"]
    newChooseColors = []
        ...
        return (
            ...
            <View>
                <View style={styles.choosen__colors}>
                    ...
                    <View style={[styles.color__choose, { backgroundColor: this.chooseColors[2], borderStyle: this.isChoose[2] ? 'solid' : 'dashed' }]}>
                        {this.isChoose[2] ? <Text style={styles.clearColor} onPress={() => this.clearColor(2)}>x</Text> : <Text style={styles.notChoosen}>+</Text>}
                    </View>
                </View>
...
export default ColorPaletteSmallSeq;